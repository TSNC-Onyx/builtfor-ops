...
function DiscordPortal({ open, setOpen }: { open: boolean; setOpen: (v: boolean) => void }) {
  ...
  // Bubble: navy bg (#1B3C6E), off-white icon — readable in both light and dark.
  // boxShadow and border use rgba literals — hsl alpha-slash is invalid in JS strings.
  const bubbleStyle: React.CSSProperties = {
    ...
    boxShadow: "0 2px 12px rgba(27,60,110,0.5)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    cursor: "pointer",
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLButtonElement).style.boxShadow =
            "0 4px 20px rgba(27,60,110,0.7)";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLButtonElement).style.boxShadow =
            "0 2px 12px rgba(27,60,110,0.5)";
        }}
      >
        {/* Discord logo in off-white #F8F6F1 — readable on navy in all themes */}
