...
export function AddProspectModal({ onClose }: { onClose: () => void }) {
  ...
  function submit() {
    ...
    if (form.vertical === "other" && !form.vertical_custom.trim()) {
      setErr("Please specify the trade or industry.");
      return;
    }
    setErr("");
    add.mutate(
      {
        ...
        vertical_custom: form.vertical === "other" ? form.vertical_custom.trim() : null,
      ...
      <div className="w-full max-w-md" style={{ backgroundColor: "hsl(var(--surface))" }}>
        ...
        <div className="px-6 py-5 space-y-3 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea rows={3} value={form.notes} onChange={e => set("notes", e.target.value)} style={{ ...fieldStyle, resize: "none" }} />
          </div>
